...
import 'package:vybzzz/screen/camera_edit_screen/camera_edit_screen.dart';
...
class CameraScreenController extends BaseController
  ...
  Future<void> _initDeepArCamera() async {
    try {
      // Initialize DeepAR with configuration
      await deepArControllerPlus.value.initialize(
          androidLicenseKey: DeepARConfig.androidLicenseKey,
          iosLicenseKey: DeepARConfig.iosLicenseKey,
          resolution: Resolution.high);
      deepArControllerPlus.value.switchEffect('');
      isDeepARInitialized.value = true;
      Loggers.info('DeepAR initialized successfully with iOS key: ${DeepARConfig.iosLicenseKey.substring(0, 10)}...');
    } catch (e) {
